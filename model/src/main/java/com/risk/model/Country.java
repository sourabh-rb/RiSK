...
/**
 * This Country represents each country in the game. These countries are owned by at most 1 player at a time.
 * Some countries are interlinked with other countries, these are called neighbour countries.
 * Each country can be occupied by 'n' number of armies of the player that owns it.
 * 
 * @author shivani
 * @version 1.0
 *
...
/**
 * This method sets the name of the player as the owner of the country.
 * The player becomes the owner if he has been alloted the country by the system in the initial stage
 * or when he conquers the country.
 * @param owner Name of the player that owns the country.
 */
 ...
 * 
 * @param neighborCounties List of countries.
 */
...
/**
 * This method sets the number of armies that the player wants to place in a country.
 * 
 * @param armies
 */
